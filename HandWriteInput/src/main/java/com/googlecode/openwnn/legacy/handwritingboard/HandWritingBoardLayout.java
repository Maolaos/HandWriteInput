...
public class HandWritingBoardLayout extends AbsoluteLayout {
    ...
    private Bitmap clearBlank(Bitmap bmp, int blank) {
        ...
        return getAlphaBitmap(Bitmap.createBitmap(bmp, left, top, right - left, bottom - top),0xFFFFFFFF);
    }

    private static Bitmap getAlphaBitmap(Bitmap bitmap, int replaceThisColor) {
